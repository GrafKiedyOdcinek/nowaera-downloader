...
if (!bookId || !startPage || !endPage) {
  console.log('Usage: node nowaera.js <bookId> <startPage> <endPage>');
  process.exit(1);
}
...
(async () => {
  ...
  await page.goto('https://ebooki.nowaera.pl/', { waitUntil: 'networkidle2' });
  ...
  for (let i = startPage; i <= endPage; i++) {
    const svgUrl = `https://npm-apidistribucion.nowaera.pl/product/${bookId}/ONLINE/assets/book/pages/${i}/${i}.svg`;
